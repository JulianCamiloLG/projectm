...
@section('background')
    style="background-image: url({{ URL::asset('img/03areas_project.jpg') }}); height: 100%; max-width: 100% ; background-position: center; background-repeat: no-repeat; background-size: cover; position: relative;background-size: 100% 100%;"
@endsection
