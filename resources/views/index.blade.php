...
@section('background')
    style="background-image: url({{ URL::asset('img/01banner-home.jpg') }}); min-height: 890px; background-position: center; background-repeat: no-repeat; background-size: cover; position: relative;"
@endsection

@section('body')
<div class="row">
    <div class="col-xl-12" style="position: relative">
        <img class="img-fluid" src="{{ URL::asset('img/02banner-ingenieriadevalor.jpg') }}" alt="nosotros">
...
<div class="row">
    <div class="col-xl-12" style="position: relative">
        <img class="img-fluid" src="{{ URL::asset('img/03banner-projectytransformacion.jpg') }}" alt="nosotros">
        <div class="col-xs-12" style="position: absolute; top: 20px; left: 260px; color: white">
