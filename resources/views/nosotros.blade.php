...
<div class="container-fluid" style=" font-family: Roboto, 'Segoe UI', Tahoma, sans-serif; font-size: 2vw">
    ...
    <div class="row justify-content-cent" style="width: 100%; ">
        ...
        <div class="col-md-6 col-sm-12" style="background-color: #e0dede; position: relative; ">
            ...
            <label for="content1" style="font-size: 2vw">Ingeniero civil graduado en 1990 (UMSNH), maestría
        ...
        <div class="col-md-6 col-sm-12" style="background-color: #e0dede; position: relative; float: left">
            <label for="titulo"> <h1 style="font-size: 3vw"><strong>Harrison <br>
                                        Mesa Hernández</strong></h1>
            </label> <br> <br>
            <label for="content2" style="font-size: 2vw">Ingeniero Civil (U. Nacional), Doctor (Ph.D) en Pontificia
